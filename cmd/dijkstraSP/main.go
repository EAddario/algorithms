/******************************************************************************
 *  Execution:    go run cmd/dijkstraSP/main.go input.txt s
 ...
 *
 *  % go run cmd/dijkstraSP/main.go tinyEWD.txt 0
 *  0 to 0 (0.00)
 ...
 *
 *  % go run cmd/dijkstraSP/main.go mediumEWD.txt 0
 *  0 to 0 (0.00)
